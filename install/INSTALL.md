...
| `all skills` | Install all Skills (audit-sql, browser-automation, create-skill, grafana-dashboard, git-workflow, github-cli, gitlab-cli, learn-from-mistakes, mysql-cli, obsidian, playwright-cli, markitdown, spec-driven, xxljob-test, zadig-deploy) |
